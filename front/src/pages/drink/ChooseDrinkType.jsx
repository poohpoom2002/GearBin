...
import icon1 from "../../asset/Group 52.svg";
import icon2 from "../../asset/Group 53.svg";
import { useEffect } from "react";

function ChooseDrinkType() {
  useEffect(() => {
    ...
    <MachineZoom
      yourCode={
        <div className="w-full h-full">
          <div className="bg-yellow-bg w-full h-1/6 grid grid-cols-5 items-center px-9">
            <Link to="/mainmenu" className=" col-span-1">
              <svg
          ...
          <div className="h-5/6 text-gray-text flex flex-col justify-center">
            <h2 className="font-medium text-3xl text-center mb-24">
              ร่างกายมนุษย์มีน้ำเป็นส่วนประกอบประมาณร้อยละ 70...
            </h2>
            <div className="flex justify-around">
              <Link
                to="/choosebottledrink"
                className="bg-type-card flex flex-col items-center w-[30%] justify-between rounded-3xl pb-10 hover:scale-105 hover:bg-hover-card"
              >
                <img src={icon1} alt="" className="-translate-y-12" />
                <p className="font-medium text-4xl">บรรจุขวด</p>
              </Link>
              <Link
                to="/choosecafedrink"
                className="bg-type-card flex flex-col items-center w-[30%] justify-between rounded-3xl pb-10 hover:scale-105 hover:bg-hover-card"
              >
                <img src={icon2} alt="" className="-translate-y-20" />
                <p className="font-medium text-4xl">คาเฟ่</p>
              </Link>
              <Link
                to="/press"
                className="bg-type-card flex flex-col items-center w-[30%] justify-between rounded-3xl pb-10 hover:scale-105 hover:bg-hover-card"
              >
                ...
                >
                  <g clip-path="url(#clip0_249_13965)">
                    <path
                      d="M166.521 40.6197L149.102 237.174C148.356 245.569 141.32 252 132.882 252H43.1402C34.7022 252 27.6667 245.569 26.9202 237.174L9.47852 40.6197V32.0444H166.521V40.6197Z"
                      fill="white"
                    />
                    <path
                      d="M166.521 23.4691L164.711 7.22128C164.259 3.11418 160.775 0 156.613 0H19.387C15.2472 0 11.7633 3.11418 11.2883 7.22128L9.47852 23.4691V32.0444H166.521V23.4691Z"
                      fill="#ECECEC"
                    />
                    <path
                      d="M172.742 40.6198H3.25758C1.47044 40.6198 0 39.1755 0 37.3702V26.7188C0 24.9361 1.44781 23.4692 3.25758 23.4692H172.742C174.53 23.4692 176 24.9361 176 26.7188V37.3702C176 39.1755 174.552 40.6198 172.742 40.6198Z"
                      fill="#D9D9D9"
                    />
                    <path
                      d="M154.578 200.977L165.572 76.8613H10.4297L21.424 200.977H154.578Z"
                      fill="#C7A670"
                    />
                    <path
                      opacity="0.15"
                      d="M88.0007 94.9146H30.2012L38.0058 182.924H88.0007V94.9146Z"
                      fill="white"
                      stroke="white"
                      stroke-width="8"
                      stroke-linecap="round"
                  ...
                  <defs>
                    <clipPath id="clip0_249_13965">
                      <rect width="176" height="252" fill="white" />
                    </clipPath>
                  </defs>
                </svg>
                <p className="font-medium text-4xl">เครื่องดื่มแบบกด</p>
              </Link>
            </div>
          </div>
        </div>
...
export default ChooseDrinkType;
