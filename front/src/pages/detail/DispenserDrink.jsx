...
import RTDDetailComponent from "../../component/MenuDetail/RTDDetailComponent";
import rtdHeadIcon from "../../asset/rtdHeadIcon.svg";
import DispenserDrinkComponent from "../../component/MenuDetail/DispenserDrinkComponent";
    ...
    <MachineZoom
      yourCode={
        <div className="w-full h-full">
          <div className="bg-yellow-bg w-full h-1/6 flex items-center justify-between px-9">
            <Link to={"/press"}>
              <svg
            ...
            <div className="flex items-end gap-x-2 h-full translate-y-2">
              <svg
                width="98"
                height="111"
                viewBox="0 0 98 111"
              ...
              <img src={rtdHeadIcon} alt="" />
            </div>
          </div>
          <DispenserDrinkComponent
            keynum={param}
            pic={data.url}
