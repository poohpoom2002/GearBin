...
import lid from "../../asset/drinks 1.png";

function DispenserDrinkComponent({ keynum,pic, menu, price, detail, brand }) {
  ...
  return (
    <div className="flex h-5/6 px-11 gap-x-11">
      ...
      <div className="basis-3/5 flex flex-col gap-y-5 justify-center">
        ...
        <div className="flex flex-row gap-x-14 justify-center">
...
export default DispenserDrinkComponent;
